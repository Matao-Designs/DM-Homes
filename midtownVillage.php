...
<div class="container-fluid" id="mainContent">
    ...
    <div class="row text-center" style="margin-top: 150px;">
        ...
        <h2>Midtown Village</h2>
        <div class="line2"></div>
<br><br>
    </div>

    <section id="autumnCreekMap" style="background-image: url('Media/Images/rentals/Rental/midtownVillage-bg.JPG'); min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        ...
        <div class="hidden-xs hidden-sm col-md-4 col-lg-4">
            <!--Map-->
            <!--Google Map-->
            <script src="Scripts/jquery/googleMapMidtownVillage.js"></script>
                    ...
                    <div class="col-xs-12 col-md-8 col-md-push-2">
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <!--Midtoen Village Image-->
                                <img src="Media/Images/rentals/Rental/midtownVillage.JPG" class="img-responsive"/>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <p style="text-align: left">
                                    DM Homes owns multiple residential rental properties in south eastern Michigan. Each of these
                                    properties are in great neighborhoods, close to shopping, good schools, as well as restaurants and bars.
