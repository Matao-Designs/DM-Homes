            ...
            <div class="row">
                <div class="cols-xs-12 col-xs-12 col-md-10 col-md-push-1">
                    ...
                    <div id="owlCarousel" class="owl-carousel">
                        ...
                        <div class="item text-center"><h5>The Glenwood</h5><img src="Media/Images/Models/The_Glenwood.png" alt="The Glenwood" style="margin: auto"><br><a href="Models/theGlenwood.php?prev=nottingham"   class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Lancaster</h5><img src="Media/Images/Models/The_Lancaster.png" alt="The Lancaster" style="margin: auto"><br><a href="Models/theLancaster.php?prev=nottingham"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Manchester</h5><img src="Media/Images/Models/The_Manchester.png" alt="The Manchester" style="margin: auto"><br><a href="Models/theManchester.php?prev=nottingham"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Oxford</h5><img src="Media/Images/Models/The_Oxford.png" alt="The Oxford" style="margin: auto"><br><a href="Models/theOxford.php?prev=nottingham"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Nottingham</h5><img src="Media/Images/Models/The_Nottingham.png" alt="The Nottingham" style="margin: auto"><br><a href="Models/theNottingham.php?prev=nottingham"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Sherwood</h5><img src="Media/Images/Models/The_Sherwood.png" alt="The Sherwood" style="margin: auto"><br><a href="Models/theSherwood.php?prev=nottingham"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
