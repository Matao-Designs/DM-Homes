...
<br><br>
    ...
    <section id="autumnCreekMap" style="background-image: url('Media/Images/rentals/Commercial/marketStreet-bg.JPG'); background-position: center; min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        <div class="col-xs-12 col-sm-12 col-md-8 text-center">

            <h3 style="color: white; font-family: 'Crimson Text', serif"><span class="fa fa-map-marker fa-3x" style="color: orangered"></span><br>Located:</h3>
            <h4 style="color: white; font-family: 'Crimson Text', serif">
                North of Hall Road (M-59)
                <br>
                between Schoenherr Rd. &amp; Hayes Rd.
            </h4>
        </div>
        ...
        <div class="hidden-xs hidden-sm col-md-4 col-lg-4">
            <!--Map-->
            <!--Google Map-->
            <script src="Scripts/jquery/googleMapMarketStreet.js"></script>
                    ...
                    <div class="col-xs-12 col-md-8 col-md-push-2">
                        <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <img src="Media/Images/rentals/Commercial/marketStreetRendering.jpg" class="img-responsive" />

                            </div>
                            <div class="col-xs-12  col-md-10 col-md-push-1">
                                <p style="text-align: left">
                                    DM Homes owns multiple commercial rental properties. Market Street, located in Shelby Charter Township, Michigan
                                    is one of those properties. Market Street is located in the epicenter of a very busy shopping center directly off Hall Road. These units offer
                                    a fresh and modern look as well as visible store fronts on the front and rear of the building. Multiple points of entrance from roads makes these commercial
                                    units the perfect retail, salon or office space that require huge exposure.
