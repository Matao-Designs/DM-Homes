<?php
    ...
    $modelName = "The Bridgeport";
    $sqFt = "";
    $folderName = "The_Bridgeport";
...
<div class="container-fluid">
    <div class="row text-center">
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <p id="details">
                <strong>Model: </strong><?php echo $modelName ?> || <strong>Bed: </strong>2-3 <strong>Bath: </strong>2.5
            </p>

            <a href="../Media/Images/Models/<?php echo $folderName ?>/theBridgeport.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
