<?php
    ...
    $modelName = "The Manchester";
    $sqFt = "3,900";
    $folderName = "The_Manchester";
...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Manchester/bg.png');">
            ...
            <h2 id="modelName">
               <?php echo $modelName ?>
                ...
                <p id="details">
                    ...
                    <div class="row elevationImage text-center" style="margin-bottom: 20px;">
                        <div class="col-sm-12 col-md-6 col-md-push-3">
                            <img src="../Media/Images/Models/The_Manchester.jpg" class="img-responsive" style="margin: auto; text-align: center;"/>
                        </div>
                    </div>
                ...
                <div class="line"></div>
                    ...
                    ?>
            <a href="../Media/Images/Models/revisedBrochures/Manchester.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
