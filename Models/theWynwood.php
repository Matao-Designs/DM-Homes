...
$modelName = "The Wynwood";
$sqFt = "2,520";
$folderName = "The_Wynwood";
?>
<!DOCTYPE html>
<html>
...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Wynwood/bg.png');">
            ...
            <div class="col-xs-12 col-md-8 col-md-push-2">
                ...
                <div class="row elevationImage text-center" style="margin-bottom: 20px;">
                    <div class="col-sm-12 col-md-6 col-md-push-3">
                        <img src="../Media/Images/Models/The_Wynwood.jpg" class="img-responsive" style="margin: auto; text-align: center;" />
                    </div>
                </div>
                ...
                <a href="../Media/Images/Models/revisedBrochures/Wynwood.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
