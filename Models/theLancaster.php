...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Lancaster/bg.png');">
...
<div class="container-fluid">
    <div class="row text-center">
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <p id="details">
                <strong>Model: </strong>The Lancaster || <strong>Sq. Ft. </strong>3,492
            </p>

             <div class="row elevationImage text-center" style="margin-bottom: 20px;">
                    <div class="col-sm-12 col-md-6 col-md-push-3">
                        <img src="../Media/Images/Models/The_Lancaster.jpg" class="img-responsive" style="margin: auto; text-align: center;"/>
                    </div>
            </div>
            ...
            <a href="../Media/Images/Models/revisedBrochures/Lancaster.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
