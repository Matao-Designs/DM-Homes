...
echo '<div class="hidden" id="theFloorplan"><img src="'.$thisFloorPlan.'" class="img-responsive" style="margin: auto"/></div>';
...
<div class="container-fluid">
    <div class="row text-center">
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <a href="../Media/Images/Models/<?php echo $folderName ?>/floor-plansBig.png" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
