<?php
    ...
    $modelName = "The Nottingham";
    $sqFt = "2,938";
    $folderName = "The_Nottingham";
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Nottingham/bg.png');">

<?php
    //print floorplan on page for jquery
    echo '<div class="hidden" id="theFloorplan"><img id="theActualFloorplan" src="'.$thisFloorPlan.'" class="img-responsive" style="height: 500px; width: auto; margin: auto"/></div>';
    //print thumbs
    echo "<div class='hidden' id='thumbs'>";
        foreach ($thumbnails as $x)
        {
            echo '<img style="width: 200px;" class="thumb" src="../Scripts/PHP/InteractiveFloorPlanDev/app/web/upload/small/'.$x.'"/>';
        }
    echo"</div>";
    //print thumbs
    echo "<div class='hidden' id='large'>";
        ...
        {
            echo '<img style="max-height: 200px;" class="large" src="../Scripts/PHP/InteractiveFloorPlanDev/app/web/upload/large/'.$x.'"/>';
        }
    echo"</div>";
?>
        ...
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <div class="row elevationImage text-center" style="margin-bottom: 20px;">
                <div class="col-sm-12 col-md-6 col-md-push-3">
                    <img src="../Media/Images/Models/The_Nottingham.jpg" class="img-responsive" style="margin: auto; text-align: center;"/>
                </div>
            </div>
            ...
            ?>
            <a href="../Media/Images/Models/revisedBrochures/Nottingham.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
