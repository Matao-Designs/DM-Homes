<?php
    ...
    $modelName = "The Alexis";
    $sqFt = "1,907";
    $folderName = "The_Alexis";
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Alexis/bg.png');">
...
<div class="container-fluid">
    <div class="row text-center">
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <a href="../Media/Images/Models/revisedBrochures/theAlexis.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
