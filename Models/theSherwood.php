<?php
    ...
    $modelName = "The Sherwood";
    $sqFt = "2,857";
    $folderName = "The_Sherwood";
?>
...
<body class="theBody" style="background-image: url('../Media/Images/Models/The_Sherwood/bg.png');">
    <?php
        ...
        <div class="col-xs-12 col-md-8 col-md-push-2">
            ...
            <div class="row elevationImage text-center" style="margin-bottom: 20px;">
                <div class="col-sm-12 col-md-6 col-md-push-3">
                    <img src="../Media/Images/Models/The_Sherwood.jpg" class="img-responsive" style="margin: auto; text-align: center;"/>
                </div>
            </div>
            ...
            ?>
            <br>
            <a href="../Media/Images/Models/revisedBrochures/Sherwood.pdf" class="btn btn-default close-buttons" target="_blank"><span class="fa fa-download"></span> Download Plan</a>
