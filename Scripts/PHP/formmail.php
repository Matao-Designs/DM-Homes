...
if($robots == "10") {
    ...
    // OPTIONAL SETTING
    $redirect_url = 'http://www.dmhomesinc.com?messageSent=1'; // Example: http://domain.com/thankyou.html - must be a FULL URL.
    ...
    if (!mail($mail_to, $message_subject, $message_body, $mail_from)):
