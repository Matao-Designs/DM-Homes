...
<div class="container-fluid" id="mainContent">
    ...
    <div class="row text-center" style="margin-top: 200px;">
        <img src="Media/Images/Valencia/valenciaMapLogo.png" alt="Valencia logo" class="img-responsive" style="margin: auto; width: 100px"/>
...
<br><br>
    ...
    <section id="theVistasMap" style="background-image: url('Media/Images/theVistas-bg.png'); min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        <div class="col-xs-12 col-sm-12 col-md-8 text-center">
            ...
            <h4 style="color: white; font-family: 'Crimson Text', serif">
                Schoenherr Road just South of 22 Mile
               <br>
        ...
        <div class="hidden-xs hidden-sm col-md-4 col-lg-4">
            <!--Map-->
            <!--Google Map-->
            <script src="Scripts/jquery/googleMapValencia.js"></script>
...
<!--            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2929.4927347589614!2d-83.00621321310261!3d42.75678348525958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8824e465514e7bc5%3A0xe159019d355c1aea!2s13598+29+Mile+Rd%2C+Washington%2C+MI+48094!5e0!3m2!1sen!2sus!4v1474082391201" width="100%" height="350" frameborder="0" style="border:0; margin: auto" allowfullscreen></iframe>-->
        ...
        <div class="container-fluid">
            <div class="row text-center">
                ...
                <p class="col-md-8 col-md-push-2">
                    Valencia will be located in the premier area of Shelby Township, and will consist of 69 daylight and wooded lots. The large lots provide a wide variety of scenery. Many of the lots are filled with natural park foliage, combined with a winding creek as well as several of the lots backing up to the woods.
                    <br><br>
                    Valencia is also located in the award winning Utica Community School District. Currently, a large senior living center is being constructed, offering the ability to stay close to your family at any point in life. Located just North of Hall Road, you will enjoy easy access to both M-53 as well as M-59 express ways.
                    <br><br>
            ...
            <div class="row">
                <div class="cols-xs-12 col-xs-12 col-md-10 col-md-push-1">
                    ...
                    <div id="owlCarousel" class="owl-carousel">
                        ...
                        <div class="item text-center"><h5>The Glenwood</h5><img src="Media/Images/Models/The_Glenwood.png" alt="The Glenwood" style="margin: auto"><br><a href="Models/theGlenwood.php?prev=valencia"   class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Lancaster</h5><img src="Media/Images/Models/The_Lancaster.png" alt="The Lancaster" style="margin: auto"><br><a href="Models/theLancaster.php?prev=valencia"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Manchester</h5><img src="Media/Images/Models/The_Manchester.png" alt="The Manchester" style="margin: auto"><br><a href="Models/theManchester.php?prev=valencia"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Oxford</h5><img src="Media/Images/Models/The_Oxford.png" alt="The Oxford" style="margin: auto"><br><a href="Models/theOxford.php?prev=valencia"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Nottingham</h5><img src="Media/Images/Models/The_Nottingham.png" alt="The Nottingham" style="margin: auto"><br><a href="Models/theNottingham.php?prev=valencia"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Sherwood</h5><img src="Media/Images/Models/The_Sherwood.png" alt="The Sherwood" style="margin: auto"><br><a href="Models/theSherwood.php?prev=valencia"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
    ...
    <section id="communityMap" style="margin-left: -15px; margin-right: -15px;">
        <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
            <div class="col-xs-12 col-md-6 autumnCreekMap text-center" style="background-image: url('Media/Images/Valencia/valenciaMapbg.jpg'); height: 540px;">

                <img src="Media/Images/Valencia/valenciaMapLogo.png" class="img-responsive" style="margin: auto;padding-top: 100px;"/>
...
<br>
            ...
            <div id="specHomes" class="col-xs-12 col-md-6 text-center autumnCreekMap" style="background-image: url('Media/Images/specHomes-bg.png'); height: 540px;">
                ...
                <div style="color: white; height: 250px; overflow-y: auto; overflow-x: hidden">
                    ...
                    <script type="text/javascript" src="/Scripts/PHP/CMS/index.php?controller=pjFront&action=pjActionLoad&id=5&hide=1"></script>
                </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="Media/Images/Valencia/valenciaMap.jpg" class="img-responsive" alt="Valencia map"/>
