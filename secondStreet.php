...
<br><br>
    ...
    <section id="autumnCreekMap" style="background-image: url('Media/Images/rentals/Commercial/secondStreet-bg.png'); min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        ...
        <div class="hidden-xs hidden-sm col-md-4 col-lg-4">
            <!--Map-->
            <!--Google Map-->
            <script src="Scripts/jquery/googleMapsecondStreet.js"></script>
                    ...
                    <div class="col-xs-12 col-md-8 col-md-push-2">
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <img src="Media/Images/rentals/Commercial/secondStreet.jpg" class="img-responsive" />

                            </div>
                            <div class="col-xs-12 col-md-6">
                                <p style="text-align: left">
                                    DM Homes owns multiple commercial rental properties. Second Street, located in Rochester, Michigan
                                    is one of those properties. Second Street offers a quiet location that is in the heart of downtown Rochester. With
                                    plenty of floor space, this property is perfect for commercial retail or offices.
