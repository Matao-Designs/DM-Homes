...
<h4 class="text-center">Bathrooms</h4>
    <div class="row" style="margin-top: 30px">
        <div class="col-xs-12 col-sm-12 col-md-10 col-md-push-1">
            <!--Gallery-->
            <link href="http://dmhomesinc.com/Scripts/PHP/Gallery/index.php?controller=pjFront&action=pjActionLoadCss&id=6" type="text/css" rel="stylesheet" />
            <script type="text/javascript" src="/Scripts/PHP/Gallery/index.php?controller=pjFront&action=pjActionLoad&id=6"></script>
        </div>
    </div>
