                    ...
                    <div class="cols-xs-12 col-xs-12 col-md-10 col-md-push-1">
                        ...
                        <div id="owlCarousel" class="owl-carousel">
                            ...
                            <div class="item text-center">
                                <h5>The Glenwood</h5><img src="Media/Images/Models/The_Glenwood.png" alt="The Glenwood" style="margin: auto"><br><a href="Models/theGlenwood.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
                            <div class="item text-center">
                                <h5>The Lancaster</h5><img src="Media/Images/Models/The_Lancaster.png" alt="The Lancaster" style="margin: auto"><br><a href="Models/theLancaster.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
                            <div class="item text-center">
                                <h5>The Manchester</h5><img src="Media/Images/Models/The_Manchester.png" alt="The Manchester" style="margin: auto"><br><a href="Models/theManchester.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
                            <div class="item text-center">
                                <h5>The Oxford</h5><img src="Media/Images/Models/The_Oxford.png" alt="The Oxford" style="margin: auto"><br><a href="Models/theOxford.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
                            <div class="item text-center">
                                <h5>The Nottingham</h5><img src="Media/Images/Models/The_Nottingham.png" alt="The Nottingham" style="margin: auto"><br><a href="Models/theNottingham.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
                            <div class="item text-center">
                                <h5>The Sherwood</h5><img src="Media/Images/Models/The_Sherwood.png" alt="The Sherwood" style="margin: auto"><br><a href="Models/theSherwood.php?prev=valencia" class="btn btn-default"><span class="fa fa-search"></span> View Details</a>
                            </div>
        ...
        <section id="communityMap" style="margin-left: -15px; margin-right: -15px;">
            <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
                ...
                <div id="specHomes" class="col-xs-12 col-md-6 text-center autumnCreekMap" style="background-image: url('Media/Images/specHomes-bg.png'); height: 540px;">
                   ...
                   <script type="text/javascript" src="http://dmhomesinc.com/Scripts/PHP/CMS/index.php?controller=pjFront&action=pjActionLoad&id=9"></script>
                </div> -->
                    ...
                    <div class="specHomes" aria-label="Avaliable Spec Homes">
                        ...
                        <div class="specHome">
                            <div class="specImage">
                                <img src="./Media/Images/specHomes/lot41/IMG_6189.JPG" alt="Spec Homes">
                            </div>
                            <div class="info">
                                <h3 class="title">Model: Nottingham</h3>
                                <div class="flexRow">
                                    <div class="squareFootage">2,938 sq. ft.</div>
                                    <div class="lotNumber">Lot 41</div>
