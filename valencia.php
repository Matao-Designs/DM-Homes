    ...
    <section id="theVistasMap" style="background-image: url('Media/Images/silverCreek-bg.png'); min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        <div class="col-xs-12 col-sm-12 col-md-8 text-center">
            ...
            <h4 style="color: white; font-family: 'Crimson Text', serif">
                Schoenherr Road between 21 Mile Rd. and Hall Rd.
                <br>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                ...
                <p class="col-md-8 col-md-push-2">
                    ...
                    <br><br>
                    Valencia is also located in the award winning Utica Community School District. Currently, a large senior living center is being constructed, offering the ability to stay close to your family at any point in life. Located just North of Hall Road, you will enjoy easy access to both M-53 as well as M-59 expressways.
                    <br><br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Valencia Subdivision Map</h4>
            </div>
            <div class="modal-body">
