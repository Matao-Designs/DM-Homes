...
<div class="container-fluid" id="mainContent">
    ...
    <div class="row text-center" style="margin-top: 200px;">
        <img src="Media/Images/Vistas%20Logo,%20Burgundy_Header.png" alt="Autumn Creek logo" class="img-responsive" style="margin: auto; width: 100px"/>

        <h2>The Vistas of Rochester Hills</h2>
        <div class="line2"></div>
<br><br>
    </div>
    ...
    <section id="theVistasMap" style="background-image: url('Media/Images/theVistas-bg.png'); min-height: 420px; padding-top: 100px; padding-bottom: 100px">
        <div class="col-xs-12 col-sm-12 col-md-8 text-center">
            ...
            <h4 style="color: white; font-family: 'Crimson Text', serif">
                East Avon Road between John R &amp; Rochester Road
               <br>
        ...
        <div class="hidden-xs hidden-sm col-md-4 col-lg-4">
            <!--Map-->
            <!--Google Map-->
            <script src="Scripts/jquery/googleMapTheVistas.js"></script>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                ...
                <p class="col-md-6 col-md-push-3">
                    The Vistas of Rochester Hills offer high end luxuries including a vast list of interior and exterior amenities. The community is located in the acclaimed Rochester Community School District and minutes from Downtown Rochester. Your home will feature beautiful architectural elevations and floor plans.                </p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="cols-xs-12 col-xs-12 col-md-10 col-md-push-1">
                    ...
                    <div id="owlCarousel" class="owl-carousel">
                        ...
                        <div class="item text-center"><h5>The Glenwood</h5><img src="Media/Images/Models/The_Glenwood.png" alt="The Glenwood" style="margin: auto"><br><a href="Models/theGlenwood.php?prev=theVistas"   class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Lancaster</h5><img src="Media/Images/Models/The_Lancaster.png" alt="The Lancaster" style="margin: auto"><br><a href="Models/theLancaster.php?prev=theVistas"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Manchester</h5><img src="Media/Images/Models/The_Manchester.png" alt="The Manchester" style="margin: auto"><br><a href="Models/theManchester.php?prev=theVistas"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        ...
                        <div class="item text-center"><h5>The Nottingham</h5><img src="Media/Images/Models/The_Nottingham.png" alt="The Nottingham" style="margin: auto"><br><a href="Models/theNottingham.php?prev=theVistas"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
                        <div class="item text-center"><h5>The Sherwood</h5><img src="Media/Images/Models/The_Sherwood.png" alt="The Sherwood" style="margin: auto"><br><a href="Models/theSherwood.php?prev=theVistas"  class="btn btn-default"><span class="fa fa-search"></span> View Details</a></div>
    ...
    <section id="communityMap" style="margin-left: -15px; margin-right: -15px;">
        <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
            <div class="col-xs-12 col-md-6 autumnCreekMap text-center" style="background-image: url('Media/Images/theVistasMap-bg.png'); height: 540px;">

                <img src="Media/Images/Vistas%20Logo,%20Burgundy_Header.png" class="img-responsive" style="margin: auto;padding-top: 100px;"/>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">The Vistas of Rochester Hills<br> Subdivision Map</h4>
            </div>
            <div class="modal-body">
                <img src="Media/Images/theVistasMap.png" class="img-responsive" alt="autumn creek map"/>
